var ipUrl = "/xdData/xdDataManage.ashx?XAction=GetDataInterface&XKLX=SCDXXNJX"; //公用的ip地址，公用的图片地址
var baseUrl = "/scdx/admin"
var httpurl=""
//请求数据ajax
	...
	layui.use(['layer'], function() {
		...
		submitDataVertifyModule("确定要批量删除吗", function() {
			PostData({
				...
				if(datadel.msg || datadel.success) {
					tipMsg(datadel, callback)
				}
			})
		})
