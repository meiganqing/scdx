...
! function(a, b) {
	...
	function J(b, c, d) {
		var e = '<{0} class="{1}">{2}</{0}>',
			...
			i = a(e.format(c.stepsContainerTag, "steps " + c.clearFixCssClass, '<ul role="tablist" class="steps"></ul>')),
...
//			n = a('<li role="tab"  class="complete"><a aria-controls="' + j + '" id="' + h + '" href="#' + k + '"><span class="title">'+m+'</span><span class="chevron"></span></li>')
			
			n = a('<li role="tab"><a id="' + h + '" href="#' + k + '" aria-controls="' + j + '"><div>' + m + '</div></a></li>');
	...
	var $ = a.fn.steps.contentMode = {
		...
		cb = a.fn.steps.defaults = {
			...
			titleTemplate: '<p class="number">#index#</p> <p class="text">#title#</p>',
